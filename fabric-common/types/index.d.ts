...
export class Utils {
  ...
  public static newCryptoKeyStore(
...
export class RedactEventer extends ServiceEndpoint {
  constructor(name: string, client: Client, mspid: string);
  public disconnect(): void;
  public checkConnection(): Promise<boolean>;
}
...
export class Proposal extends ServiceAction {
  ...
  public addChaincodeCollectionsInterest(
    collectionName: string,
    collectionNames: string[]
  ): Proposal;
  public addChaincodeNoPrivateReadsCollectionsInterest(
    collectionName: string,
    noPrivateReads: boolean,
    collectionNames: string[]
  ): Proposal;
  public build(
    idContext: IdentityContext,
...
interface RedactEventListener {
  onEvent(error: Error, event: RedactEventInfo): void;
  unregisterEventListener(): void;
}

export type RedactEventCallback = (
  error?: Error,
  event?: RedactEventInfo
) => void;

export interface RedactEventInfo {
...
export class EventService extends ServiceAction {
  ...
  public registerChaincodeListener(
    chaincodeId: string,
    eventName: string,
    callback: EventCallback,
    options: EventRegistrationOptions
  ): EventListener;
  public registerBlockListener(
    callback: EventCallback,
    options: EventRegistrationOptions
  ): EventListener;
...
export class RedactEventService extends ServiceAction {
  constructor(chaincodeName: string, channel: Channel);
  public setEventer(discoverer: RedactEventer): RedactEventService;
  public close(): void;
  public build(idContext: IdentityContext): Buffer;
  public send(request?: StartEventRequest): Promise<void>;
  public isListening(): boolean;
  public unregisterEventListener(
    eventListener: RedactEventListener
  ): RedactEventService;
  public registerBlockListener(
...
export class Client {
  ...
  public setCentralizedConnectionOptions(
    options: Record<string, unknown>
  ): Client;
  ...
  public newRedactEventer(name: string, mspid?: string): RedactEventer;
...
export class Channel {
  ...
  public newRedactEventService(name: string): RedactEventService;
